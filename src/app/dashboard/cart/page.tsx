        ...
        <div className="flex flex-col w-full sm:w-4/12">
          <WidgetItem title="Total">
            <div className="mt-2 flex justify-center gap-4">
              <h3 className="text-3xl font-bold text-gray-700">{`$${(totalToPay * 1.19).toFixed(2)}`}</h3>
            </div>
            <span className="font-bold text-center text-gray-500">{`Impuestos 19% = $${(totalToPay * 0.19)}`}</span>
          </WidgetItem>
        </div>
      </div>
    </div>
